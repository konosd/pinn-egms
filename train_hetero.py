...
if __name__ == '__main__':
    ...
    input_size = 2
    output_size = 1
    net_d = FNN_D([input_size] + [hidden_layer_size] * num_hidden_layers + [output_size])
    ...
    trainer = model_trainer_egm_heterogeneous(net_ap,net_d, train_set, test_set, batch_size, geomtime, bc, criterion, my_system)
